      ...
      <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-10 shadow-lg border border-indigo-100">
        <div className="text-center mb-8">
          ...
          <p className="text-indigo-700 text-lg leading-relaxed max-w-3xl mx-auto">
            Take a break from the AI challenges and relax with our therapeutic games. 
            Perfect for stress relief and mental wellness.
          </p>
        </div>
        <div
        ...
        >
          ...
          <p className="text-indigo-100 mb-6 leading-relaxed text-lg">
            Explore our collection of therapeutic games including bubble popping, 
            memory matching, breathing exercises, and more. Designed to help you 
